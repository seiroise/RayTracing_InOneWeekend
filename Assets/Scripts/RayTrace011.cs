...
public class RayTrace011
{
	...
	[MenuItem("ImageBuilder/RayTrace011")]
	public static void Test001()
	{
		...
		var lookfrom = new Vec3(-1f, 1f, -1f);
		var lookat = new Vec3(0f, 0f, 1f);
		// var focusDist = (lookfrom - lookat).length;

		var cam = new Camera(lookfrom, lookat, new Vec3(0f, 1f, 0f), 90f, w / h, 2f);
		...
		ImageBuilder.SaveImage(c, w, h, "output_camera");
	}
}