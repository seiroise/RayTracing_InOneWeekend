...
namespace Test
{
	public class Raytracer07
	{
		...
		public static void Trace()
		{
			...
			scene.list.Add(new Sphere(new Vec3(0f, -0.3f, 0.6f), 0.15f, new Metal(new Vec3(1f, 1f, 0.2f), 0.5f)));
			...
			ImageBuilder.SaveImage(c, w, h, "/Test/Images/07_ouput");
		}
	}
}